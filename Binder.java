...
public class Binder implements IBinder {
    ...
    // just a log method
    private static void permissionlog (int code, int dataObj, int replyObj, int flags){
	...
	try {
		...
		out.write("The code is ==> " + code + "\tThe dataObj is ==> " + dataObj + "\tThe replyObj is ==> " + replyObj + "\tFlags is ==> " + flags);
	...
	permissionlog(code, dataObj, replyObj, flags);
	//ends of insertion
